...
namespace XQuant {
	...
	void FTrendChart::onImGuiRender() {
		...
		ImGui::Begin(_name.c_str(), &_isShow, ImGuiWindowFlags_MenuBar);

		static ETrendTime _curTrendTime = ETrendTime::eTTDay;
		// 菜单栏
		if (ImGui::BeginMenuBar()) {
			for (int i = (int)ETrendTime::eTTTimeShare; i < (int)ETrendTime::eTT60Minute; i++) {
				if (i == (int)_curTrendTime) {
					ImGui::PushStyleColor(ImGuiCol_Button, IM_COL32(255, 0, 0, 255));
					if (ImGui::Button(TrendTimeName[ETrendTime(i)].c_str())) {
						_curTrendTime = (ETrendTime)i;
					}
					ImGui::PopStyleColor();
				}
				else {
			...
			//float fontWidth = ImGui::CalcTextSize(u8"布林").x;
			//ImGui::SetCursorPosX(ImGui::GetWindowSize().x - fontWidth - 10.0f);
			//if (ImGui::Button(u8"布林")) {

			//}

			//ImGui::SetCursorPosX(ImGui::GetWindowSize().x - fontWidth * 2.0f - 10.0f);
			//if (ImGui::Button(u8"均线")) {

			//}

			//ImGui::SetCursorPosX(ImGui::GetWindowSize().x - fontWidth * 3.5f - 10.0f);
			//if (ImGui::Button(u8"加自选")) {
		...
		// K线图
		{
			...
			if (ImPlot::BeginPlot(u8"走势图", ImVec2(-1, -1))) {
				...
				drawCandlestickChart("GOOGL", dates, opens, closes, lows, highs, 218, tooltip, 0.25f, bullCol, bearCol);
				ImPlot::EndPlot();
			}
		}

		//// 绘制中间分隔线
		//ImGui::GetWindowDrawList()->AddLine({ ImGui::GetWindowPos().x + 0.0f, ImGui::GetWindowPos().y + 600.0f },
		//	{ ImGui::GetWindowPos().x + 0.0f, ImGui::GetWindowPos().y + 600.0f }, ImColor(111, 111, 111, 255));

		//// 指标图
		//if (ImGui::BeginTabBar("IndicatorTabBar", ImGuiTabBarFlags_None))
		//{
		//	if (ImGui::BeginTabItem(u8"KDJ"))
		//	{
		//		ImGui::Text("This is the Broccoli tab!\nblah blah blah blah blah");
		//		ImGui::EndTabItem();
		//	}
		//	if (ImGui::BeginTabItem(u8"RSI"))
		//	{
		//		ImGui::Text("This is the Cucumber tab!\nblah blah blah blah blah");
		//		ImGui::EndTabItem();
		//	}
		//	if (ImGui::BeginTabItem(u8"Boll"))
		//	{
		//		ImGui::Text("This is the Cucumber tab!\nblah blah blah blah blah");
		//		ImGui::EndTabItem();
		//	}
